  ...
  return (
    <div>
          ...
          <div class="row">
            <div class="col-md-3 text-center text-md-start">
              <img
                ...
                alt="Xpo Media Logo"
                style={{ width: "135px" }}
                class="img-fluid mb-2  ms-lg-5"
              />
              <p className="mt-2 lh-lg">
                Streamline and automate your school's daily academic and
                administrative operations with Xpo Media. Elevate efficiency,
                enhance productivity, and experience seamless digital school
            ...
            <div class="col-md-3 ps-5 lh-base  my-5">
              ...
              <p>
                {" "}
                📍151/23, Thirumanjana Gopura Street, (Opp) Kamarajar Statue,
                Tiruvannamalai - 606601.
              </p>
              <p>📧 govindanmcas@gmail.com</p>
              <p>📧 xpomediasoft@gmail.com</p>
              ...
              <div class="d-flex  gap-2">
                <a href="#" class="text-white fs-5">
                  <img style={{ width: "30px" }} src={linkdin} alt="" />
                </a>
                <a href="#" class="text-white fs-5">
                  <img style={{ width: "30px" }} src={inst} alt="" />
                </a>
                <a href="#" class="text-white fs-5">
                  <img style={{ width: "30px" }} src={twailter} alt="" />
                </a>
                <a href="#" class="text-white fs-5">
     ...
     border-top mt-3 pt-3"
          >
            All Rights Reserved &copy; 2025 Xpo Media Since 2000
          </p>
        </div>
      </footer>
    </div>
